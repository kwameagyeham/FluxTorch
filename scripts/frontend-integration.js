 ...
 * This file demonstrates how to integrate Fluxtorch with a web frontend
 */

// For React/Vue/Angular applications
export class FluxtorchClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FluxtorchClient(provider, contractAddress);
